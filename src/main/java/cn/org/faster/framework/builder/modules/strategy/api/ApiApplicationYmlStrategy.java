 ...
 * @since 2018/12/15
 */
public class ApiApplicationYmlStrategy extends BuildStrategy {
    public ApiApplicationYmlStrategy(BuilderModel builderModel) {
        super(builderModel);
    ...
    public void process(ZipOutputStream zipOutputStream) throws IOException {
        Template ymlTemp = FreemarkerUtils.cfg.getTemplate("api/application.yml.ftl");
