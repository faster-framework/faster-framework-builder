//package cn.org.faster.framework.builder.old.api;
//
//import cn.org.faster.framework.builder.old.engine.JavaBuilderEngine;
...
//    private String testModulePackage;
...
//    private Template ymlTemp = FreemarkerUtils.cfg.getTemplate(API_TEMPLATE_DIR + "/application.yml.ftl");
//    private Template testTemp = FreemarkerUtils.cfg.getTemplate(API_TEMPLATE_DIR + "/test.ftl");
//
...
//        testModulePath = TEST_JAVA_PATH + super.builderParam.getBasePath() + "/modules/v1/";
//        testModulePackage = super.builderParam.getBasePackagePath() + ".modules.v1";
//        //创建压缩文件
...
//                this.processTest(testTemp, tableColumnModel, zipOutputStream);
//            }
//        }
//        return Utils.inputStreamToByteArray(new FileInputStream(zipFile));
//    }
//
//    private void processTest(Template testTemp, TableColumnModel tableColumnModel, ZipOutputStream zipOutputStream) throws IOException {
//        //文件名称
//        String zipFileName = testModulePath + tableColumnModel.getBusinessEnName() + tableColumnModel.getBusinessEnNameUpFirst() + "Test.java";
//        //包名
//        String packageStr = "package " + testModulePackage + "." + tableColumnModel.getBusinessEnName() + ";\n";
